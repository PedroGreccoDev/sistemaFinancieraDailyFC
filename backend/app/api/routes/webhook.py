...
_NOMBRE_INTENT = {
    ...
    "COBRAR_INTERES": "el cobro del interés",
    "ABONAR_CAPITAL": "la devolución de capital",
    "CANCELAR_PRESTAMO": "la cancelación del préstamo",
    "EDITAR_INTERES_FIJO": "el cambio del interés",
