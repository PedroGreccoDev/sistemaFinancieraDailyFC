          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:items-center">
            <div>
              ...
              <input
                ...
                className="border border-slate-200 rounded px-3 py-1.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            <div>
            ...
            <table className="w-full text-sm min-w-[320px]">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200">
                  ...
                  <th className="text-right px-4 py-3 font-medium text-slate-600">Ganancia</th>
              ...
              <tbody>
                {[
                  ...
                  return (
                    <tr key={row.label} className="border-b border-slate-100">
                      ...
                      <td className="px-4 py-3 text-right font-semibold text-slate-900">{fmtARS(row.value)}</td>
                ...
                <tr className="bg-slate-50 font-semibold">
                  ...
                  <td className="px-4 py-3 text-right text-indigo-700">{fmtARS(data.total)}</td>
