...
const pasivos: Pasivo[] = [
  { id: 'pa-1', acreedor: 'Proveedor Papelería SA', concepto: 'Resma y tóner',       monto: '120000', saldo_pendiente: '120000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: d(10), fecha_cancelacion: null,  observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-12), updated_at: ts(-12) },
  { id: 'pa-2', acreedor: 'Inmobiliaria Centro',    concepto: 'Alquiler del local',  monto: '200000', saldo_pendiente: '200000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: d(3),  fecha_cancelacion: null,  observaciones: 'Mes corriente', cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-8),  updated_at: ts(-8) },
  { id: 'pa-3', acreedor: 'Importadora Global',     concepto: 'Mercadería en USD',   monto: '1500',   saldo_pendiente: '1500',   moneda: 'USD', estado: 'PENDIENTE', fecha_vencimiento: d(20), fecha_cancelacion: null,  observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-5),  updated_at: ts(-5) },
  { id: 'pa-4', acreedor: 'Ferretería Norte',       concepto: 'Insumos varios',      monto: '45000',  saldo_pendiente: '0',      moneda: 'ARS', estado: 'CANCELADA', fecha_vencimiento: d(-2), fecha_cancelacion: d(-5), observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-20), updated_at: ts(-5) },
  // Un mismo acreedor con varias deudas y en las dos monedas: es el caso normal
  // del negocio y el que muestra para qué sirve agrupar por acreedor.
  { id: 'pa-5', acreedor: 'Importadora Global',     concepto: 'Lote de dólares a deber', monto: '2300', saldo_pendiente: '2300', moneda: 'USD', estado: 'PENDIENTE', fecha_vencimiento: d(14), fecha_cancelacion: null, observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-4),  updated_at: ts(-4) },
  { id: 'pa-6', acreedor: 'importadora global',     concepto: 'Cheque comprado sin pagar', monto: '890000', saldo_pendiente: '540000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: d(6), fecha_cancelacion: null, observaciones: 'Pagado en parte', cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, cotizacion_ingreso_usd: null, created_at: ts(-3),  updated_at: ts(-1) },
  { id: 'pa-7', acreedor: 'Importadora Global',     concepto: 'Me prestó plata',     monto: '400000', saldo_pendiente: '400000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: null,  fecha_cancelacion: null, observaciones: null,            cotizacion_pago: null, ingreso_caja: true,  fecha_ingreso: d(-2), cotizacion_ingreso_usd: null, created_at: ts(-2),  updated_at: ts(-2) },
]
...
const reporte: ReporteCaja = {
  ...
  ganancia_cheques: {
    total: '118500', ventas: '74000', cobros: '31500', fiados: '13000',
    cantidad: 6, rechazos: '90000',
  },
