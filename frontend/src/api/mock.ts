...
const pasivos: Pasivo[] = [
  { id: 'pa-1', acreedor: 'Proveedor Papelería SA', concepto: 'Resma y tóner',       monto: '120000', saldo_pendiente: '120000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: d(10), fecha_cancelacion: null,  observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, created_at: ts(-12), updated_at: ts(-12) },
  { id: 'pa-2', acreedor: 'Inmobiliaria Centro',    concepto: 'Alquiler del local',  monto: '200000', saldo_pendiente: '200000', moneda: 'ARS', estado: 'PENDIENTE', fecha_vencimiento: d(3),  fecha_cancelacion: null,  observaciones: 'Mes corriente', cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, created_at: ts(-8),  updated_at: ts(-8) },
  { id: 'pa-3', acreedor: 'Importadora Global',     concepto: 'Mercadería en USD',   monto: '1500',   saldo_pendiente: '1500',   moneda: 'USD', estado: 'PENDIENTE', fecha_vencimiento: d(20), fecha_cancelacion: null,  observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, created_at: ts(-5),  updated_at: ts(-5) },
  { id: 'pa-4', acreedor: 'Ferretería Norte',       concepto: 'Insumos varios',      monto: '45000',  saldo_pendiente: '0',      moneda: 'ARS', estado: 'CANCELADA', fecha_vencimiento: d(-2), fecha_cancelacion: d(-5), observaciones: null,            cotizacion_pago: null, ingreso_caja: false, fecha_ingreso: null, created_at: ts(-20), updated_at: ts(-5) },
]
